...
const milestones = [
  ...
  { year: '2024 Q4', title: 'Segurança & Backup', desc: 'Sistema de backup JSON total e importação segura de dados.', status: 'done' },
  { year: '2025 Q1', title: 'Padronização CRM', desc: 'Seleção dinâmica de raças por espécie e suporte multi-tenant (Raio Studio).', status: 'done' },
  { year: '2025 Q2', title: 'IA & Automação', desc: 'Assistente virtual para pré-diagnóstico e lembretes automáticos via WhatsApp.', status: 'current' },
  { year: '2025 Q3', title: 'Fidelidade & App', desc: 'Sistema de pontos, carteira digital e expansão do aplicativo mobile.', status: 'future' },
