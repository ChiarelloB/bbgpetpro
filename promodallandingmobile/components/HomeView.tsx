...
export const HomeView: React.FC<HomeViewProps> = ({ pets, appointments, onSelectPet, onAddPet, onToggleAppointment, onManagePets }) => {
  ...
  return (
    <div className="space-y-6 animate-[fadeIn_0.5s_ease-out]">
      {/* Greeting Section */}
      <div className="mt-2">
        <h2 className="text-3xl font-light text-white/80">Bom dia,</h2>
