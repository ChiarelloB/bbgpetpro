            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full h-12 rounded-xl border-white/10 bg-white/5 text-white font-bold focus:ring-primary px-4"
                  placeholder="0.00"
                />
              </div>
              <div>
  ...
  const handleSaveService = async (service: ServiceItem) => {
    try {
      const dbService = {
        ...
        price_pequeno: parseFloat(service.price_pequeno) || 0,
        price_medio: parseFloat(service.price_medio) || 0,
        price_grande: parseFloat(service.price_grande) || 0,
